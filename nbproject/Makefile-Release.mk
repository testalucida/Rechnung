...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rechnung2: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rechnung2 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/1618188523/RechnungGroup.o: /home/max/cpp/fltk/Rechnung2/src/RechnungGroup.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1618188523/RechnungGroup.o /home/max/cpp/fltk/Rechnung2/src/RechnungGroup.cpp

${OBJECTDIR}/_ext/1618188523/UebersichtTree.o: /home/max/cpp/fltk/Rechnung2/src/UebersichtTree.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1618188523
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1618188523/UebersichtTree.o /home/max/cpp/fltk/Rechnung2/src/UebersichtTree.cpp

${OBJECTDIR}/src/DetailTabs.o: src/DetailTabs.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DetailTabs.o src/DetailTabs.cpp

${OBJECTDIR}/src/MainHandler.o: src/MainHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MainHandler.o src/MainHandler.cpp

${OBJECTDIR}/src/MySql.o: src/MySql.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MySql.o src/MySql.cpp

${OBJECTDIR}/src/PrintHandler.o: src/PrintHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PrintHandler.o src/PrintHandler.cpp

${OBJECTDIR}/src/PrintView.o: src/PrintView.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PrintView.o src/PrintView.cpp

${OBJECTDIR}/src/PrintablePage.o: src/PrintablePage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PrintablePage.o src/PrintablePage.cpp

${OBJECTDIR}/src/Rechnung.o: src/Rechnung.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Rechnung.o src/Rechnung.cpp

${OBJECTDIR}/src/RechnungHandler.o: src/RechnungHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RechnungHandler.o src/RechnungHandler.cpp

${OBJECTDIR}/src/RechnungIO.o: src/RechnungIO.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RechnungIO.o src/RechnungIO.cpp

${OBJECTDIR}/src/RechnungPosGroupPrint.o: src/RechnungPosGroupPrint.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RechnungPosGroupPrint.o src/RechnungPosGroupPrint.cpp

${OBJECTDIR}/src/RechnungTableData.o: src/RechnungTableData.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RechnungTableData.o src/RechnungTableData.cpp

${OBJECTDIR}/src/RechnungToolBar.o: src/RechnungToolBar.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/RechnungToolBar.o src/RechnungToolBar.cpp

${OBJECTDIR}/src/StatisticIO.o: src/StatisticIO.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StatisticIO.o src/StatisticIO.cpp

${OBJECTDIR}/src/StatistikHandler.o: src/StatistikHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StatistikHandler.o src/StatistikHandler.cpp

${OBJECTDIR}/src/TreeHandler.o: src/TreeHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/TreeHandler.o src/TreeHandler.cpp

${OBJECTDIR}/src/UebersichtModel.o: src/UebersichtModel.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/UebersichtModel.o src/UebersichtModel.cpp
